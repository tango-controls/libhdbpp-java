 ...
 */
public class HdbLong extends HdbScalarData {
  ...
  public static HdbData createData(SignalInfo info) throws HdbFailed
  {
    ...
    {
      case SCALAR:
        return new HdbLong(info);
      case SPECTRUM:
        return new HdbLongArray(info);
      default:
  ...
  @Override
  public HdbLong copyData()
  {
    return new HdbLong(info, value, wvalue);
  }
