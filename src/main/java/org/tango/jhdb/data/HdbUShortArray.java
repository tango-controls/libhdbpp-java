...
public class HdbUShortArray extends HdbArrayData {
  ...
  public HdbUShortArray(SignalInfo info) {
    super(info);
  }

  public HdbUShortArray(SignalInfo info, int[] value, int[] wvalue) {
    this(info);
  ...
  public void parseValue(ArrayList<Object> value) throws HdbFailed {
    ...
    this.value = parseUShortArray(value);
  ...
  public void parseWriteValue(ArrayList<Object> value) throws HdbFailed {
    ...
    if(value!=null)
      this.wvalue = parseUShortArray(value);

  }

  private int[] parseUShortArray(ArrayList<Object> value) throws HdbFailed {
  ...
  void copyData(HdbData src) {
    value = ((HdbUShortArray)src).value.clone();
    if(((HdbUShortArray)src).wvalue!=null)
      wvalue = ((HdbUShortArray)src).wvalue.clone();
  }
